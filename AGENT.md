...
- For now the simulator advances one stop per tick instead of storing continuous coordinate breadcrumbs
- The nearest-hub return decision is implemented even though full live position playback is postponed
